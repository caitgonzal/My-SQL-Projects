...
CREATE TABLE `appointments` (
  `appointmnet_id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `appointments_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `staff` (`staff_id`)
...
-- Dump completed on 2025-04-06 15:09:43
